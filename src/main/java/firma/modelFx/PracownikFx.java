...
public class PracownikFx {
    ...
    private BooleanProperty czy_pracuje_aktualnie =  new SimpleBooleanProperty();
    ...
    private IntegerProperty id_placowka_sprzedarzy = new SimpleIntegerProperty();
    private IntegerProperty id_placowka_naprawcza = new SimpleIntegerProperty();
    ...
    public boolean isCzy_pracuje_aktualnie() {
        return czy_pracuje_aktualnie.get();
    }

    public BooleanProperty czy_pracuje_aktualnieProperty() {
        return czy_pracuje_aktualnie;
    }

    public void setCzy_pracuje_aktualnie(boolean czy_pracuje_aktualnie) {
    ...
    public int getId_placowka_sprzedarzy() {
        return id_placowka_sprzedarzy.get();
    }

    public IntegerProperty id_placowka_sprzedarzyProperty() {
        return id_placowka_sprzedarzy;
    }

    public void setId_placowka_sprzedarzy(int id_placowka_sprzedarzy) {
        this.id_placowka_sprzedarzy.set(id_placowka_sprzedarzy);
    }

    public int getId_placowka_naprawcza() {
        return id_placowka_naprawcza.get();
    }

    public IntegerProperty id_placowka_naprawczaProperty() {
        return id_placowka_naprawcza;
    }

    public void setId_placowka_naprawcza(int id_placowka_naprawcza) {
