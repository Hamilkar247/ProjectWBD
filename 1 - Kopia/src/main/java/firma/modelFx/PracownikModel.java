    ...
    public void init(){
        ...
        try {
            ...
            while (rs.next())
            {
                ...
                pracownikFxTmp.setId_pracownik(rs.getInt("id_pracownik"));
                ...
                pracownikFxTmp.setId_centrala(rs.getInt("id_centrala"));
                pracownikFxTmp.setId_placowka_sprzedarzy(rs.getInt("id_placowka_sprzedarzy"));
                pracownikFxTmp.setId_placowka_naprawcza(rs.getInt("id_placowka_naprawcza"));
